...
#define TEST_CLK_CPU_TARGET_RATE	200000000ULL
#define TEST_CLK_CPU_UNSUPP_RATE	123456789ULL
...
static rpmi_uint32_t get_cpu_rates_expdata[] = {
	...
	RATE_LO(400000000ULL),
	RATE_HI(400000000ULL),
};
