...
| Version | Source |
|---------|--------|
| v1.0 (Ratified) | [riscv-non-isa/riscv-rpmi tag v1.0](https://github.com/riscv-non-isa/riscv-rpmi/releases/tag/v1.0) |
| v2.0 (Draft) | [riscv-non-isa/riscv-rpmi main branch AsciiDoc sources](https://github.com/riscv-non-isa/riscv-rpmi/tree/main) — no stable tag; reviewed against the tree as of 2025-07-16 |
...
| 0x0007 | VOLTAGE | ✅ Complete | ⏳ Partial | Missing S-mode tests |
| 0x0008 | CLOCK | ✅ Complete | ⏳ Partial | Missing S-mode tests |
| 0x0009 | DEVICE_POWER | ✅ Complete | ⏳ Partial | Missing S-mode tests |
...
| Service Group ID | Service Group Name | Implementation | Tests | Notes |
|-----------------|-------------------|----------------|-------|-------|
| 0x000E | LOGGING | ✅ Complete | ✅ Complete | N/A |
